...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try (TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BubbleSeekBar, defStyleAttr, 0)) {
            ...
            mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                    ContextCompat.getColor(context, R.color.colorNormal));
        ...
        mBubbleView.setProgressText(mBubbleValueToTextConverter.convertValueToText(
                this, getProgress(), getProgressFloat(), isShowProgressInFloat));
